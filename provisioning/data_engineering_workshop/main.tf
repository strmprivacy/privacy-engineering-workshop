locals {
  service_account_id = "data-engineering-workshop"
  service_account_display_name = "Data Engineering Workshop"
...
resource "google_storage_bucket_object" "picture" {
  name   = "data-engineering-workshop-gcs-bucket-write-sa.json"
